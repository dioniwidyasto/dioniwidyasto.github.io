...
document.querySelector(".hilang2").addEventListener("click", () => {
  notif2();
  jamtgl("14:45", "Friday, 8 March 2024");
  gantiBg(2);
});
document.querySelector(".hilang3").addEventListener("click", () => {
  notif3();
  jamtgl("19:35", "Sunday, 17 March 2024");
  gantiBg(3);
});
document.querySelector(".hilang4").addEventListener("click", () => {
  notif4();
  jamtgl("21:35", "Thursday, 21 March 2024");
  gantiBg(4);
});
document.querySelector(".hilang5").addEventListener("click", () => {
  notif5();
  jamtgl("16:52", "Friday, 29 March 2024");
  gantiBg(5);
});
document.querySelector(".hilang6").addEventListener("click", () => {
  notif6();
  jamtgl("20:33", "Monday, 1 April 2024");
  gantiBg(6);
});
...
// Custom
var pengirim = "";
var musik = "https://dekatutorial.github.io/musik/IU%20Love%20wins%20all%20Easy%20Lyrics.mp3";
var ucapansatu =
  "Haii An..#Ini momen pertama kali kita bertemu, mas menjawab tantanganmu untuk mencari seorang wanita yang bernama Annis Safira Nur Aulia di tempat yang mungkin jumlahnya ada ratusan orang di sana..😏##Alhamdulillah hanya berbekal nekat, doa, usaha dan sedikit clue darimu..#Mas Dion dan Annis bisa bertemu di Sunmor UGM atas izin Allah hehe❣️";
var ucapandua =
  'Dan yaaa..#Ini adalah momen yang paling aneh dari takdir yang diberikan Allah untuk kita🤣🤣🤣##Setelah 12 x percobaan gagalku untuk mengajakmu keluar, akhirnya Annis malah yang ngajak mas keluar😆##Dan gak main2 ges..#Setelah kita makan bareng di Sooji, Mas Dionnya disuruh nganterin dari Jogja ke Semarang WKWKKWKW..##Meskipun katanya sih "terpaksa" karena doi sakit 😋##Tapi alhamdulillah ya ini awal yang baik buat kita..sesuai tujuan kita, Annis sembuh dari penyakit dan bisa tidur😊';
var ucapantiga =
  "Ciee cieeee..#Ini toh ngedate kedua kita yang berkedok nugas 🤭##Ngedate pertamanya sih di geisha tapi ya gitu deh Annisnya masih malu2 ndak mau foto🤣##Tapi meskipun ngedate kedua, menurut Mas Dion chemistry kita mulai terbentuk di sini ges..##Annis nunjukkin foto ini ke Mama Tri dan Mas Dion nunjukkin foto ini ke Ibuk Hani,#Dan hasilnyaaaaa..#Tanggapan Mama dan Ibuk sangat positif.. yeaaaaaayyyy😊";
var ucapanempat =
  "Hmmm ini ngedate kita yang ketiga ya?#Masih gebetan siii tapiiii kok udah kerasa kek pacaran 😆##Yang mas Dion inget banyak tawa disini dan udah gak malu2 kucing seperti pertemuan kita sebelumnya..##Malam yang indah ini kita tutup  dengan deeptalk2 di depan Kos Pak Totok dan yaaa itu yang membuat hubungan kita makin dekat dan dewasa 😊";
var ucapanlima =
  "Makan unagi bersama yeyeyeyeye..##Makanannya semua enak, pemandangannya juga bagus ditambah Annis manja banget di momen ini, komplit sudah xixixixi🤭##Masih inget gak Annis marahin bapak2 ngerokok di depan anaknya dan polisi yang parkir sembarangan?WKWKWKKWKWKW##Dan yang gak pernah mas lupa.. Saat itu Annis udah gak malu gombalin dan nunjukkin love language ke mas Dion 🥰##Boleh jujur ga si Annis mulai ada cinta sama mas Dion dari sini?😋";
var ucapanenam =
  "Awalnya..#Hari itu diawali dengan Annis yang badmood karena gagal puasa karena diah🤣##Udah bad mood masih aja ditambah kejadian2 berikutnya yang menambah hari itu makin kelam, dari gagal ke mahaloka paradise karena mas Dion telat dateng, hujan yang gak berhenti2, sampai di bukit bintang masih aja hujan dan dapet tempat yg kurang bersih 😔##Tapiiii..#Tanpa itu semua cinta kita tidak akan bersatu.. meskipun banyak ujian di hari itu, kita masih tetap saling menguatkan dan berusaha untuk menghibur satu sama lain 🫶##Yah ini adalah hari dimana cinta kita berdua terikat..#Hari paling kelam sekaligus hari paling bahagia untuk kita berdua 💞##I love you An❤️";
// ============================
...
var background1 = "bg.jpg";
var background2 = "bg.jpg";
var noWhatsapp = "";
var pesanWhatsapp = "";
...
async function start() {
  ...
  audio.play();
  await swalo.fire({ title: "Are you in a good mood today?", showDenyButton: 1, confirmButtonText: "Ok", denyButtonText: "Cancel", reverseButtons: true }).then(async (e) => {
    if (e.isConfirmed) {
      klik.play();
      await swalo.fire({ title: "I love you An ❤️" });
    }
    if (e.isDenied) {
      klik.play();
    ...
    klik.play();
    await swalo.fire({ title: "Mas mau sampein sesuatu.." });

    klik.play();
    await swalo.fire({ title: "Cieee kepoo ya?", showDenyButton: 1, confirmButtonText: "BANGETT", denyButtonText: "IYAA", reverseButtons: true });

    klik.play();
    await swalo.fire({ title: "Wkwkwkwk okaaay.." });
...
const carslide = document.querySelectorAll(".carousel-slide");

//
const jamE = document.querySelector("#jam");
const tglE = document.querySelector(".tgl");

function jamtgl(jam, tgl) {
  jamE.textContent = jam;
  tglE.textContent = tgl;
}
function gantiBg(no) {
  carslide[no - 1].classList.remove("d-none");
}
jamtgl("09:44", "Sunday, 3 March 2024");
